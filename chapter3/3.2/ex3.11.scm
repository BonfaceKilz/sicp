...
;;procedures with local state. Now we have seen how internal
;;definitions work. A typical message-passing procedure contains both
;;of these aspects. Consider the bank account procedure of 3.1.1:
