...
;; created as a parameter of make-withdraw. We could also create
...
;; Recall from 1.3.2 that let is simply synctactic sugar for a
;; procedure call:
;; (let ((<var> <exp>)) <body>)
...
;; with the same behaviour. How do environment structures differ
;; for the 2 versions?
